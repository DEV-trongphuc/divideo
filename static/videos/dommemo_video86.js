(function() {
    ...
    function renderGfx(slideId, canvas) {
        ...
        if (slideId === 'slide_memo86_1') {
            ...
            if (needsTemplate) {
                canvas.innerHTML = `
                    <div class="memo-wrapper slide-memo86-2-container">
                        <span class="ambient-sleep-particle-v86" style="top: 8%; left: 85%; animation-delay: -2s;">🧠</span>
                        <span class="ambient-sleep-particle-v86" style="top: 82%; left: 10%; animation-delay: -4s;">🚧</span>

                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v86 node-1">
                                <span class="diagram-node-icon">🚧</span>
                                <span>1. Đầu Vào</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v86 node-2">
                                <span class="diagram-node-icon">🧠</span>
                                <span>2. Xử Lý Não</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v86 node-3">
                                <span class="diagram-node-icon">✨</span>
                        ...
                        <div style="font-size: 15px; color: rgba(255,255,255,0.4); text-align: center; max-width: 650px; line-height: 1.5; border: 1.5px solid rgba(255,255,255,0.06); padding: 14px; border-radius: 16px; background: rgba(255,255,255,0.01); z-index: 10;">
                            💡 *Bẫy Tự giới hạn*: Hiện tượng này là Bẫy Tự giới hạn. Chúng ta tự tạo ra chướng ngại trước thử thách để có lý do đổ lỗi nếu thất bại, bảo vệ lòng tự trọng của bản thân.
                        </div>
                    </div>
                `;
            }
                    ...
                    <div class="memo-wrapper slide-memo86-4-container">
                        ...
                        <div class="comp-row-v86">
                            <div class="comp-card-v86 card-left card-active">
                                ...
                                <div class="comp-footer-v86">BẢN NĂNG</div>
                            </div>

                            <div class="comp-card-v86 card-right card-inactive">
                                <div class="comp-header-v86">
                                    <h3>TRẠNG THÁI B</h3>
                                    <div class="comp-icon-v86">⚙️</div>
                                </div>
                                <div class="comp-bullet-list-v86">
                                    <div class="comp-bullet-row-v86" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v86">❌</span>
                                ...
                                <div class="comp-footer-v86">NHẬN THỨC MỚI</div>
                            </div>
                        </div>
                    </div>
                `;
