(function() {
    ...
    function renderGfx(slideId, canvas) {
        ...
        if (slideId === 'slide_memo96_1') {
            ...
            if (needsTemplate) {
                canvas.innerHTML = `
                    <div class="memo-wrapper slide-memo96-2-container">
                        <span class="ambient-sleep-particle-v96" style="top: 8%; left: 85%; animation-delay: -2s;">🧠</span>
                        <span class="ambient-sleep-particle-v96" style="top: 82%; left: 10%; animation-delay: -4s;">🎯</span>

                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v96 node-1">
                                <span class="diagram-node-icon">🎯</span>
                                <span>1. Đầu Vào</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v96 node-2">
                                <span class="diagram-node-icon">🧠</span>
                                <span>2. Xử Lý Não</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v96 node-3">
                                <span class="diagram-node-icon">✨</span>
                        ...
                        <div style="font-size: 15px; color: rgba(255,255,255,0.4); text-align: center; max-width: 650px; line-height: 1.5; border: 1.5px solid rgba(255,255,255,0.06); padding: 14px; border-radius: 16px; background: rgba(255,255,255,0.01); z-index: 10;">
                            💡 *Hiệu quả Bản thân*: Đó gọi là Hiệu ứng Hiệu quả Bản thân. Niềm tin vững chắc vào việc mình có thể hoàn thành nhiệm vụ trực tiếp thúc đẩy sự kiên trì và nỗ lực.
                        </div>
                    </div>
                `;
            }
                    ...
                    <div class="memo-wrapper slide-memo96-4-container">
                        ...
                        <div class="comp-row-v96">
                            <div class="comp-card-v96 card-left card-active">
                                ...
                                <div class="comp-footer-v96">BẢN NĂNG</div>
                            </div>

                            <div class="comp-card-v96 card-right card-inactive">
                                <div class="comp-header-v96">
                                    <h3>TRẠNG THÁI B</h3>
                                    <div class="comp-icon-v96">⚙️</div>
                                </div>
                                <div class="comp-bullet-list-v96">
                                    <div class="comp-bullet-row-v96" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v96">❌</span>
                                ...
                                <div class="comp-footer-v96">NHẬN THỨC MỚI</div>
                            </div>
                        </div>
                    </div>
                `;
