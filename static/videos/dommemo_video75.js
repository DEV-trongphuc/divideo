(function() {
                        ...
                        <div class="comp-row-v75">
                            <div class="comp-card-v75 card-left card-active">
                                <div class="comp-header-v75">
                                    <h3>Người Nhân Chứng Độc Nhất</h3>
                                ...
                                <div class="comp-bullet-list-v75">
                                    <div class="comp-bullet-row-v75" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Gánh vác 100% trách nhiệm đạo đức</span>
                                    </div>
                                    <div class="comp-bullet-row-v75" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v75">✨</span>
                                        <span>Không thể đổ lỗi cho ai khác</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v75">100% TRÁCH NHIỆM</div>
                            </div>

                            <div class="comp-card-v75 card-right card-inactive">
                                <div class="comp-header-v75">
                                    <h3>Đám Đông Nhiều Người</h3>
                                    <div class="comp-icon-v75">👥</div>
                                </div>
                                <div class="comp-bullet-list-v75">
                                    <div class="comp-bullet-row-v75" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v75">❌</span>
                                        <span>Trách nhiệm bị chia nhỏ cho số đông</span>
                                    </div>
                                    <div class="comp-bullet-row-v75" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v75">❌</span>
                                        <span>Ai cũng chờ người khác đi trước</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v75">PHÂN TÁN</div>
                            </div>
                        </div>
                    </div>
                `;
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo75_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo75_4' && canvas.querySelector('.comp-row-v75')) {
        ...
        else if (slideId === 'slide_memo75_5' || (slideId === 'slide_memo75_4' && canvas.querySelector('.takeaway-box-v75'))) {
