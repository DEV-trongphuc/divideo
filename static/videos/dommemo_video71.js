                            ...
                            <div class="comp-card-v71 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v71">
                                    <div class="comp-bullet-row-v71" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Nhận biết rõ từng nhịp tim đập</span>
                                    </div>
                                    <div class="comp-bullet-row-v71" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v71">✨</span>
                                        <span>Cảm thấy run rẩy dữ dội</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v71">LO LẮNG 90%</div>
                            </div>

                            <div class="comp-card-v71 card-right card-inactive">
                                <div class="comp-header-v71">
                                    <h3>Nhận Diện Số Đông</h3>
                                    <div class="comp-icon-v71">👥</div>
                                </div>
                                <div class="comp-bullet-list-v71">
                                    <div class="comp-bullet-row-v71" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v71">❌</span>
                                        <span>Chỉ nhìn thấy hình ảnh đứng yên</span>
                                    </div>
                                    <div class="comp-bullet-row-v71" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v71">❌</span>
                                        <span>Thấy giọng nói tương đối ổn định</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v71">NHÌN THẤY 5%</div>
                            </div>
                        </div>
                    </div>
                `;
                ...
                canvas.innerHTML = `
                    <div class="memo-wrapper slide-memo71-4-container">
                        ...
                        <div class="sleep-diagram-board" style="width:720px; height:340px; display:flex; justify-content:center; align-items:center; background:rgba(0,0,0,0.25);">
                            <pre style='color:#a7f3d0; font-family:monospace; text-align:left; font-size:15px; line-height:1.6; background:rgba(0,0,0,0.5); padding:20px; border-radius:12px; margin:0;'>// PHÂN TÍCH ẢO GIÁC MINH BẠCH
let internalIntensity = 100;
let observerPerception = internalIntensity * 0.05; // Chỉ thấy 5%
console.log(\`Người khác thấy lo lắng ở mức: \${observerPerception}%\`);</pre>
                        </div>

                        <div style="font-size: 15px; color: rgba(255,255,255,0.4); text-align: center; max-width: 650px; line-height: 1.5; border: 1.5px solid rgba(255,255,255,0.06); padding: 14px; border-radius: 16px; background: rgba(255,255,255,0.01); z-index: 10;">
                            💡 *Quy luật Trí Não*: So sánh: Cảm giác cá nhân tự thấy mình lộ liễu 90%. Thực tế, người quan sát chỉ phát hiện chưa tới 5% dấu hiệu lo lắng.
                        </div>
                    </div>
                `;
            }
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo71_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo71_4' && canvas.querySelector('.comp-row-v71')) {
        ...
        else if (slideId === 'slide_memo71_5' || (slideId === 'slide_memo71_4' && canvas.querySelector('.takeaway-box-v71'))) {
