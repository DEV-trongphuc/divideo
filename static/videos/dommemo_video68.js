(function() {
                    ...
                    <div class="memo-wrapper slide-memo68-2-container">
                        ...
                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v68 node-1">
                                ...
                                <span>1. Tin xấu xuất hiện</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v68 node-2">
                                <span class="diagram-node-icon">🧠</span>
                                <span>2. Não sợ tổn thương</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v68 node-3">
                                <span class="diagram-node-icon">🙈</span>
                                <span>3. Tránh né đối mặt</span>
                            </div>
                        </div>
                            ...
                            <div class="comp-card-v68 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v68">
                                    <div class="comp-bullet-row-v68" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Nhận diện sự thật khách quan</span>
                                    </div>
                                    <div class="comp-bullet-row-v68" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v68">✨</span>
                                        <span>Xử lý rủi ro kịp thời</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v68">CHỦ ĐỘNG</div>
                            </div>

                            <div class="comp-card-v68 card-right card-inactive">
                                <div class="comp-header-v68">
                                    <h3>Tránh Né Đà Điểu</h3>
                                    <div class="comp-icon-v68">🦩</div>
                                </div>
                                <div class="comp-bullet-list-v68">
                                    <div class="comp-bullet-row-v68" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v68">❌</span>
                                        <span>Bóp méo thực tế để an ủi</span>
                                    </div>
                                    <div class="comp-bullet-row-v68" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v68">❌</span>
                                        <span>Bỏ qua các cảnh báo đỏ</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v68">THỤ ĐỘNG</div>
                            </div>
                        </div>
                    </div>
                `;
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo68_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo68_4' && canvas.querySelector('.comp-row-v68')) {
        ...
        else if (slideId === 'slide_memo68_5' || (slideId === 'slide_memo68_4' && canvas.querySelector('.takeaway-box-v68'))) {
