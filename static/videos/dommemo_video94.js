                            ...
                            <div class="comp-card-v94 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v94">
                                    <div class="comp-bullet-row-v94" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Kế hoạch hoàn thành xuất sắc</span>
                                    </div>
                                    <div class="comp-bullet-row-v94" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v94">✨</span>
                                ...
                                <div class="comp-footer-v94">10% NGHI NGỜ</div>
                            </div>

                            <div class="comp-card-v94 card-right card-inactive">
                                <div class="comp-header-v94">
                                    <h3>Nhận Thức Giả Mạo</h3>
                                    <div class="comp-icon-v94">🎭</div>
                                </div>
                                <div class="comp-bullet-list-v94">
                                    <div class="comp-bullet-row-v94" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v94">❌</span>
                                        <span>Cho rằng thành công do may mắn</span>
                                    </div>
                                    <div class="comp-bullet-row-v94" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v94">❌</span>
                                        <span>Luôn lo sợ bị bóc phốt năng lực</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v94">85% NGHI NGỜ</div>
                            </div>
                        </div>
                    </div>
                `;
                ...
                canvas.innerHTML = `
                    <div class="memo-wrapper slide-memo94-4-container">
                        ...
                        <div class="sleep-diagram-board" style="width:720px; height:340px; display:flex; justify-content:center; align-items:center; background:rgba(0,0,0,0.25);">
                            <pre style='color:#a7f3d0; font-family:monospace; text-align:left; font-size:15px; line-height:1.6; background:rgba(0,0,0,0.5); padding:20px; border-radius:12px; margin:0;'>// CHỈ SỐ HỘI CHỨNG GIẢ MẠO
let successScore = 95;
let selfDoubt = 85;
if (successScore > 90 && selfDoubt > 80) {
    status = "Impostor State Active";
    console.log("Cảm thấy mình đang diễn kịch");
}</pre>
                        </div>

                        <div style="font-size: 15px; color: rgba(255,255,255,0.4); text-align: center; max-width: 650px; line-height: 1.5; border: 1.5px solid rgba(255,255,255,0.06); padding: 14px; border-radius: 16px; background: rgba(255,255,255,0.01); z-index: 10;">
                            💡 *Quy luật Trí Não*: So sánh: Đánh giá khách quan ghi nhận nỗ lực và kết quả thực tế. Hội chứng giả mạo bóp méo thành tựu thành sự may mắn ngẫu nhiên.
                        </div>
                    </div>
                `;
            }
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo94_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo94_4' && canvas.querySelector('.comp-row-v94')) {
        ...
        else if (slideId === 'slide_memo94_5' || (slideId === 'slide_memo94_4' && canvas.querySelector('.takeaway-box-v94'))) {
