                    ...
                    <div style="width:100%; height:100%; position:relative; box-sizing:border-box; display:flex; flex-direction:column; justify-content:center; align-items:center; gap:30px; zoom:0.83;">
                        ...
                        <div class="glass-card phone-mockup maps-phone-intro" style="width:440px; height:700px; border:2.5px solid #10b981; border-radius:36px; padding:24px; display:flex; flex-direction:column; justify-content:space-between; background:#0c0f17; position:relative; overflow:hidden; box-shadow:0 25px 60px rgba(0,0,0,0.85); transition:all 0.3s;">
                            ...
                            <div style="background:#161d2a; border-radius:18px; padding:12px 18px; display:flex; align-items:center; gap:12px; border:1.5px solid rgba(255,255,255,0.06); z-index:5;">
                                <i data-lucide="search" style="color:#10b981; width:22px; height:22px;"></i>
                            ...
                            <div style="flex:1; position:relative; margin:20px 0; border-radius:20px; overflow:hidden; border:1px solid rgba(255,255,255,0.04); background:#070a12; z-index:2;">
                                ...
                                <div class="map-node start-pin" style="position:absolute; left:15%; top:75%; display:flex; flex-direction:column; align-items:center; z-index:10;">
                                    ...
                                    <span style="background:#10b981; color:#000; font-size:13px; font-weight:bold; padding:2px 8px; border-radius:6px; margin-top:2px; white-space:nowrap;">Quận 1</span>
                                </div>
                                ...
                                <svg style="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:5;" class="intro-svg-canvas">
                                    ...
                                    <!-- Gold Winner Route -->
                                    <path class="intro-winner-path" d="M 66 382 L 150 250 L 330 250 L 330 102" fill="none" stroke="#10b981" stroke-width="7" stroke-linecap="round" style="opacity:0; transition:all 0.5s;" />
                                </svg>
                            </div>
                            ...
                            <div class="glass-card intro-eta-card" style="background:#161d2a; border-radius:20px; padding:18px; border:1.5px solid rgba(255,255,255,0.06); text-align:left; display:flex; justify-content:space-between; align-items:center; z-index:5; transform:translateY(30px); opacity:0; transition:all 0.5s;">
                                <div>
                                    <div style="font-size:24px; font-weight:900; color:#10b981;">18 phút <span style="font-size:18px; color:rgba(255,255,255,0.5); font-weight:normal;">(7.2 km)</span></div>
                                    <div style="font-size:15px; color:#d1d5db; margin-top:4px;">Tuyến đường nhanh nhất, ít kẹt xe</div>
                                </div>
                                <button style="background:#10b981; border:none; border-radius:12px; width:44px; height:44px; display:flex; align-items:center; justify-content:center; color:#000;">
                                    <i data-lucide="navigation" style="width:20px; height:20px; fill:#000;"></i>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            if (needsTemplate) {
                canvas.innerHTML = `
                    <div style="width:100%; height:100%; position:relative; box-sizing:border-box; display:flex; flex-direction:column; justify-content:center; align-items:center; gap:25px; zoom:1.22;">
                        ...
                        <div class="glass-card" style="width:100%; max-width:850px; height:480px; border:2.5px solid var(--gold-primary); border-radius:24px; padding:20px; box-sizing:border-box; background:#0c0f17; position:relative; overflow:hidden; box-shadow:0 0 25px rgba(245,158,11,0.1);">
                            ...
                            <div style="flex:1; height:380px; position:relative; margin-top:15px; background:#070a12; border-radius:16px; overflow:hidden; border:1px solid rgba(255,255,255,0.03); display:flex; justify-content:center; align-items:center;">
                                <div style="width:760px; height:100%; position:relative; margin:0 auto;">
                                    ...
                                    <svg style="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:2;" class="dijkstra-svg">
                                        ...
                                        <line x1="200" y1="100" x2="380" y2="100" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e3" />
                                        <line x1="200" y1="280" x2="380" y2="280" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e4" />
                                        <line x1="380" y1="100" x2="560" y2="100" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e5" />
                                        <line x1="380" y1="280" x2="560" y2="280" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e6" />
                                        <line x1="560" y1="100" x2="680" y2="190" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e7" />
                                        <line x1="560" y1="280" x2="680" y2="190" stroke="rgba(255,255,255,0.15)" stroke-width="3.5" class="d-edge e8" />
                                    </svg>
                                    ...
                                    <div class="d-node n-3" style="position:absolute; left:380px; top:100px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="d-node n-4" style="position:absolute; left:380px; top:280px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="d-node n-5" style="position:absolute; left:560px; top:100px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="d-node n-6" style="position:absolute; left:560px; top:280px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="d-node dest" style="position:absolute; left:680px; top:190px; width:44px; height:44px; border-radius:50%; background:#ef4444; border:2px solid #fff; transform:translate(-50%,-50%); display:flex; align-items:center; justify-content:center; font-size:16px; font-weight:bold; color:#fff; z-index:5; transition:all 0.3s;">B</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="glass-card" style="width:100%; max-width:850px; height:480px; border:2.5px solid var(--gold-primary); border-radius:24px; padding:20px; box-sizing:border-box; background:#0c0f17; position:relative; overflow:hidden; box-shadow:0 0 25px rgba(245,158,11,0.1);">
                            ...
                            <div style="flex:1; height:380px; position:relative; margin-top:15px; background:#070a12; border-radius:16px; overflow:hidden; border:1px solid rgba(255,255,255,0.03); display:flex; justify-content:center; align-items:center;">
                                <div style="width:760px; height:100%; position:relative; margin:0 auto;">
                                    ...
                                    <div class="heuristic-vector" style="position:absolute; left:120px; top:50%; width:520px; height:6px; background:linear-gradient(to right, rgba(16,185,129,0.5), transparent); transform:translateY(-50%); pointer-events:none; z-index:1; border-radius:3px;">
                                    ...
                                    <svg style="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:2;" class="astar-svg">
                                        ...
                                        <line x1="200" y1="100" x2="380" y2="100" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-3" />
                                        <line x1="200" y1="280" x2="380" y2="280" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-4" />
                                        <line x1="380" y1="100" x2="560" y2="100" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-5" />
                                        <line x1="380" y1="280" x2="560" y2="280" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-6" />
                                        <line x1="560" y1="100" x2="680" y2="190" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-7" />
                                        <line x1="560" y1="280" x2="680" y2="190" stroke="rgba(255,255,255,0.1)" stroke-width="3" class="a-edge ea-8" />
                                    </svg>
                                    ...
                                    <div class="a-node n-3" style="position:absolute; left:380px; top:100px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.2); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="a-node n-4" style="position:absolute; left:380px; top:280px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.2); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="a-node n-5" style="position:absolute; left:560px; top:100px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.2); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="a-node n-6" style="position:absolute; left:560px; top:280px; width:40px; height:40px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.2); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="a-node dest" style="position:absolute; left:680px; top:190px; width:44px; height:44px; border-radius:50%; background:#ef4444; border:2px solid #fff; transform:translate(-50%,-50%); display:flex; align-items:center; justify-content:center; font-size:16px; font-weight:bold; color:#fff; z-index:5; transition:all 0.3s;">B</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div style="flex:1; height:380px; position:relative; margin-top:15px; background:#070a12; border-radius:16px; overflow:hidden; border:1px solid rgba(255,255,255,0.03); display:flex; justify-content:center; align-items:center;">
                                <div style="width:760px; height:100%; position:relative; margin:0 auto;">
                                    <svg style="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:2;" class="hierarchy-svg">
                                        ...
                                        <path class="highway-path" d="M 80 190 L 380 90 L 680 190" fill="none" stroke="#f59e0b" stroke-width="12" stroke-linecap="round" style="opacity:0.8;" />
                                        <path class="highway-path" d="M 80 190 L 260 270 L 500 290 L 680 190" fill="none" stroke="#f59e0b" stroke-width="12" stroke-linecap="round" style="opacity:0.8;" />
                                        
                                        <!-- Local Alleys (Thin nested lines, dimmed out on click) -->
                                        <line x1="80" y1="190" x2="230" y2="140" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="230" y1="140" x2="380" y2="90" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="380" y1="90" x2="530" y2="140" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="530" y1="140" x2="680" y2="190" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        ...
                                        <line x1="260" y1="270" x2="380" y2="280" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="380" y1="280" x2="500" y2="290" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="500" y1="290" x2="590" y2="240" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                        <line x1="590" y1="240" x2="680" y2="190" stroke="rgba(255,255,255,0.25)" stroke-width="3.5" class="alley-road" />
                                    </svg>
                                    
                                    <!-- Labels for High-Level Highways -->
                                    <div style="position:absolute; left:380px; top:65px; color:#f59e0b; font-size:15px; font-weight:bold; transform:translate(-50%, -50%); text-shadow:0 2px 4px rgba(0,0,0,0.8); pointer-events:none; z-index:10;">Cao tốc CT01</div>
                                    <div style="position:absolute; left:380px; top:315px; color:#f59e0b; font-size:15px; font-weight:bold; transform:translate(-50%, -50%); text-shadow:0 2px 4px rgba(0,0,0,0.8); pointer-events:none; z-index:10;">Quốc lộ 1A</div>
                                    ...
                                    <div style="position:absolute; left:680px; top:190px; width:44px; height:44px; border-radius:50%; background:#ef4444; border:2px solid #fff; transform:translate(-50%,-50%); display:flex; align-items:center; justify-content:center; font-size:16px; font-weight:bold; color:#fff; z-index:5; box-shadow:0 0 15px #ef4444;">B</div>
                        ...
                        <div class="glass-card" style="width:100%; max-width:850px; height:480px; border:2.5px solid var(--gold-primary); border-radius:24px; padding:20px; box-sizing:border-box; background:#0c0f17; position:relative; overflow:hidden; box-shadow:0 0 25px rgba(245,158,11,0.1);">
                            ...
                            <div style="flex:1; height:380px; position:relative; margin-top:15px; background:#070a12; border-radius:16px; overflow:hidden; border:1px solid rgba(255,255,255,0.03); display:flex; justify-content:center; align-items:center;">
                                <div style="width:760px; height:100%; position:relative; margin:0 auto;">
                                    ...
                                    <div class="bidir-ripple right-wave" style="position:absolute; left:680px; top:50%; width:0px; height:0px; border-radius:50%; border:2px solid #3b82f6; background:rgba(59,130,246,0.015); transform:translate(-50%, -50%); opacity:0; z-index:1;"></div>
                                    
                                    <svg style="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:2;" class="bidir-svg">
                                        <path class="bidir-edge" d="M 80 190 L 230 190 L 380 190 L 530 190 L 680 190" fill="none" stroke="rgba(255,255,255,0.15)" stroke-width="4.5" />
                                        <!-- Dynamic glows path -->
                                        <path class="bidir-path-left" d="M 80 190 L 380 190" fill="none" stroke="#10b981" stroke-width="7" stroke-dasharray="300" stroke-dashoffset="300" />
                                        <path class="bidir-path-right" d="M 680 190 L 380 190" fill="none" stroke="#3b82f6" stroke-width="7" stroke-dasharray="300" stroke-dashoffset="300" />
                                    </svg>
                                    ...
                                    <div class="bidir-node n-l1" style="position:absolute; left:230px; top:190px; width:36px; height:36px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div class="bidir-node intersection" style="position:absolute; left:380px; top:190px; width:44px; height:44px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:10; display:flex; align-items:center; justify-content:center; font-size:22px; transition:all 0.3s;">🤝</div>
                                    <div class="bidir-node n-r1" style="position:absolute; left:530px; top:190px; width:36px; height:36px; border-radius:50%; background:#2d3748; border:2px solid rgba(255,255,255,0.3); transform:translate(-50%,-50%); z-index:5; transition:all 0.3s;"></div>
                                    <div style="position:absolute; left:680px; top:190px; width:46px; height:46px; border-radius:50%; background:#ef4444; border:2px solid #fff; transform:translate(-50%,-50%); display:flex; align-items:center; justify-content:center; font-size:16px; font-weight:bold; color:#fff; z-index:5; box-shadow:0 0 15px #ef4444;">B</div>
                                    
                                    <!-- Central Flash Glow -->
                                    <div class="bidir-flash" style="position:absolute; left:380px; top:190px; width:120px; height:120px; border-radius:50%; background:radial-gradient(circle, rgba(245,158,11,0.8) 0%, transparent 70%); transform:translate(-50%,-50%) scale(0); opacity:0; z-index:4; pointer-events:none; transition:all 0.3s;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
