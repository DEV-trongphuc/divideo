(function() {
                    ...
                    <div class="memo-wrapper slide-memo95-2-container">
                        ...
                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v95 node-1">
                                ...
                                <span>1. Phán đoán chủ quan</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v95 node-2">
                                <span class="diagram-node-icon">👑</span>
                                <span>2. Tự tin ước tính 90%</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v95 node-3">
                                <span class="diagram-node-icon">⚡</span>
                                <span>3. Đụng độ thử thách thực tế</span>
                            </div>
                        </div>
                        ...
                        <div class="comp-row-v95">
                            <div class="comp-card-v95 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v95">
                                    <div class="comp-bullet-row-v95" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Đánh giá thấp mọi rủi ro</span>
                                    </div>
                                    <div class="comp-bullet-row-v95" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v95">✨</span>
                                        <span>Bỏ qua các cảnh báo số liệu</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v95">ẢO TƯỞNG 90%</div>
                            </div>
                            ...
                            <div class="comp-card-v95 card-right card-inactive">
                                ...
                                <div class="comp-bullet-list-v95">
                                    <div class="comp-bullet-row-v95" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v95">❌</span>
                                        <span>Ước tính dựa trên kiểm chứng</span>
                                    </div>
                                    <div class="comp-bullet-row-v95" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v95">❌</span>
                                        <span>Sẵn sàng phương án dự phòng</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v95">THỰC CHẤT 40%</div>
                            </div>
                        </div>
                    </div>
                `;
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo95_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo95_4' && canvas.querySelector('.comp-row-v95')) {
        ...
        else if (slideId === 'slide_memo95_5' || (slideId === 'slide_memo95_4' && canvas.querySelector('.takeaway-box-v95'))) {
