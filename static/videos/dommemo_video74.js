(function() {
    ...
    function renderGfx(slideId, canvas) {
        ...
        if (slideId === 'slide_memo74_1') {
            ...
            if (needsTemplate) {
                canvas.innerHTML = `
                    <div class="memo-wrapper slide-memo74-2-container">
                        <span class="ambient-sleep-particle-v74" style="top: 8%; left: 85%; animation-delay: -2s;">🧠</span>
                        <span class="ambient-sleep-particle-v74" style="top: 82%; left: 10%; animation-delay: -4s;">👀</span>

                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v74 node-1">
                                <span class="diagram-node-icon">👀</span>
                                <span>1. Đầu Vào</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v74 node-2">
                                <span class="diagram-node-icon">🧠</span>
                                <span>2. Xử Lý Não</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v74 node-3">
                                <span class="diagram-node-icon">✨</span>
                        ...
                        <div style="font-size: 15px; color: rgba(255,255,255,0.4); text-align: center; max-width: 650px; line-height: 1.5; border: 1.5px solid rgba(255,255,255,0.06); padding: 14px; border-radius: 16px; background: rgba(255,255,255,0.01); z-index: 10;">
                            💡 *Hiệu ứng Khán giả*: Đó là Hiệu ứng Khán giả. Sự hiện diện của người khác làm tăng mức độ hưng phấn sinh lý, thúc đẩy việc thực hiện các tác vụ quen thuộc nhưng cản trở tác vụ khó.
                        </div>
                    </div>
                `;
            }
                    ...
                    <div class="memo-wrapper slide-memo74-4-container">
                        ...
                        <div class="comp-row-v74">
                            <div class="comp-card-v74 card-left card-active">
                                ...
                                <div class="comp-footer-v74">BẢN NĂNG</div>
                            </div>

                            <div class="comp-card-v74 card-right card-inactive">
                                <div class="comp-header-v74">
                                    <h3>TRẠNG THÁI B</h3>
                                    <div class="comp-icon-v74">⚙️</div>
                                </div>
                                <div class="comp-bullet-list-v74">
                                    <div class="comp-bullet-row-v74" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v74">❌</span>
                                ...
                                <div class="comp-footer-v74">NHẬN THỨC MỚI</div>
                            </div>
                        </div>
                    </div>
                `;
