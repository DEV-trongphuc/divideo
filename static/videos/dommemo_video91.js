(function() {
                    ...
                    <div class="memo-wrapper slide-memo91-2-container">
                        ...
                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v91 node-1">
                                ...
                                <span>1. Làm việc tự do</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v91 node-2">
                                <span class="diagram-node-icon">📹</span>
                                <span>2. Nhận diện đang bị giám sát</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v91 node-3">
                                <span class="diagram-node-icon">⭐</span>
                                <span>3. Ý thức lòng tự trọng tăng</span>
                            </div>
                        </div>
                            ...
                            <div class="comp-card-v91 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v91">
                                    <div class="comp-bullet-row-v91" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Làm việc tùy hứng, không áp lực</span>
                                    </div>
                                    <div class="comp-bullet-row-v91" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v91">✨</span>
                                        <span>Năng suất ở mức trung bình</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v91">60% HIỆU SUẤT</div>
                            </div>

                            <div class="comp-card-v91 card-right card-inactive">
                                <div class="comp-header-v91">
                                    <h3>Dưới Sự Giám Sát</h3>
                                    <div class="comp-icon-v91">📹</div>
                                </div>
                                <div class="comp-bullet-list-v91">
                                    <div class="comp-bullet-row-v91" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v91">❌</span>
                                        <span>Ý thức rõ sự đánh giá bên ngoài</span>
                                    </div>
                                    <div class="comp-bullet-row-v91" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v91">❌</span>
                                        <span>Năng suất vọt lên mức tối đa</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v91">98% HIỆU SUẤT</div>
                            </div>
                        </div>
                    </div>
                `;
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo91_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo91_4' && canvas.querySelector('.comp-row-v91')) {
        ...
        else if (slideId === 'slide_memo91_5' || (slideId === 'slide_memo91_4' && canvas.querySelector('.takeaway-box-v91'))) {
