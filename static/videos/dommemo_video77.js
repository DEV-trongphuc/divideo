(function() {
                    ...
                    <div class="memo-wrapper slide-memo77-2-container">
                        ...
                        <div class="sleep-diagram-board">
                            <div class="diagram-node-v77 node-1">
                                ...
                                <span>1. Nhóm thử thách ban đầu</span>
                            </div>
                            <span class="node-link-arrow arrow-1">➡️</span>
                            <div class="diagram-node-v77 node-2">
                                <span class="diagram-node-icon">❌</span>
                                <span>2. Số đông thất bại rơi rụng</span>
                            </div>
                            <span class="node-link-arrow arrow-2">➡️</span>
                            <div class="diagram-node-v77 node-3">
                                <span class="diagram-node-icon">🏆</span>
                                <span>3. Vài cá nhân nổi trội thắng</span>
                            </div>
                        </div>
                            ...
                            <div class="comp-card-v77 card-left card-active">
                                ...
                                <div class="comp-bullet-list-v77">
                                    <div class="comp-bullet-row-v77" style="opacity:1; transform:translateY(0);">
                                        ...
                                        <span>Chỉ sao chép thói quen tỷ phú</span>
                                    </div>
                                    <div class="comp-bullet-row-v77" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v77">✨</span>
                                        <span>Mơ tưởng công thức dễ dàng</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v77">RỦI RO CAO</div>
                            </div>

                            <div class="comp-card-v77 card-right card-inactive">
                                <div class="comp-header-v77">
                                    <h3>Nhìn Nhận Toàn Diện</h3>
                                    <div class="comp-icon-v77">🛩️</div>
                                </div>
                                <div class="comp-bullet-list-v77">
                                    <div class="comp-bullet-row-v77" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v77">❌</span>
                                        <span>Nghiên cứu lý do người khác bại trận</span>
                                    </div>
                                    <div class="comp-bullet-row-v77" style="opacity:1; transform:translateY(0);">
                                        <span class="comp-bullet-icon-v77">❌</span>
                                        <span>Nhận diện lỗ hổng hệ thống thực tế</span>
                                    </div>
                                </div>
                                <div class="comp-footer-v77">BỀN VỮNG</div>
                            </div>
                        </div>
                    </div>
                `;
    ...
    function updateFrame(slideId, canvas, progress) {
        ...
        else if (slideId === 'slide_memo77_2' && canvas.querySelector('.sleep-diagram-board')) {
        ...
        else if (slideId === 'slide_memo77_4' && canvas.querySelector('.comp-row-v77')) {
        ...
        else if (slideId === 'slide_memo77_5' || (slideId === 'slide_memo77_4' && canvas.querySelector('.takeaway-box-v77'))) {
